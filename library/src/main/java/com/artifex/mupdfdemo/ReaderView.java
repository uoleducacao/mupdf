...
public class ReaderView
    ...
    public void setOnLastPageReach(OnFinish onLastPageReach) {
        this.onLastPageReach = onLastPageReach;
    }
    ...
    public void setDisplayedViewIndex(int i) {
        ...
        if (mCurrent == mAdapter.getCount() - 1 && onLastPageReach != null)
        ...
        if (!mResetLayout) {
            ...
            if (cv != null) {
                ...
                if (cv.getTop() + cv.getMeasuredHeight() + cvOffset.y + GAP / 2 + mYScroll < getHeight() / 2 && mCurrent + 1 < mAdapter.getCount()) {
                    ...
                    if (mAdapter.getCount() - 1 == mCurrent && this.onLastPageReach != null)
                        this.onLastPageReach.reached();
                }
...
//            cvBottom += corr.y;
    ...
    public void showPageChanges(Activity activity) {
    ...
    private void initObservers() {
        ...
        this.paginationObserver = new PaginationObserver();
        t.scheduleAtFixedRate(paginationObserver, 0, 500);
    }
    ...
    public class PaginationObserver extends TimerTask {
        private int currentPage = 1;

        @Override
        public void run() {
            if (mCurrent != currentPage) {
                currentPage = mCurrent;
                ...
                mActivity.runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        toastPag = Toast.makeText(mActivity, String.format("%s de %s", mCurrent + 1, getTotalPages()), Toast.LENGTH_SHORT);
                        toastPag.show();
                    }
                });
